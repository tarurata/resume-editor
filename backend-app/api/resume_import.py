...
async def import_resume(
    ...
    try:
        ...
        logger.info(f"Resume import completed for user {request.user_id}, confidence: {confidence}")
...
async def export_resume(
    ...
    try:
        ...
        logger.info(f"Resume export requested for ID {resume_id}, format: {format}")
...
async def get_resume(
    ...
    try:
        ...
        logger.info(f"Resume retrieval requested for ID {resume_id}")
...
async def update_resume(
    ...
    try:
        ...
        logger.info(f"Resume update requested for ID {resume_id}")
...
async def delete_resume(
    ...
    try:
        ...
        logger.info(f"Resume deletion requested for ID {resume_id}")
...
async def list_resumes(
    ...
    try:
        ...
        logger.info(f"Resume listing requested for user {user_id}")
